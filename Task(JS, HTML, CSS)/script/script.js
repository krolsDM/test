document.addEventListener("DOMContentLoaded", function () {
    const questions = [
      ...
      function selectAnswer(optionElement, userAnswer) {
        ...
        if (Array.isArray(currentQuestion.correctAnswer)) {
          canProceed = selectedAnswers.length > 0; // Для множественного выбора, хотя бы один ответ должен быть выбран
        } else {
          canProceed = selectedAnswers.length === 1; // Для одиночного выбора, ровно один ответ должен быть выбран
        }
